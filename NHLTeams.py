...
DucksDef = ["Jackson LaCombe", "Brian Dumoulin", "Radko Gudas", "Pavel Mintyukov", "Drew Helleson", "Olen Zellweger", "Jacob Trouba"]
...
BruinsDef = ["Brandon Carlo", "Hampus Lindholm", "Charlie McAvoy", "Matt Grzelcyk", "Dmitry Orlov", "Mike Reilly", "Connor Clifton", "Mason Lohrei", "Michael Callahan", "Nikita Zadorov"]
...
SabresDef = ["Jacob Bryson", "Bowen Byram", "Connor Clifton", "Rasmus Dahlin", "Mattias Samuelsson"]
...
FlamesDef = ["Rasmus Andersson", "Kevin Bahl", "Tyson Barrie", "Jake Bean", "Joel Hanley", "MacKenzie Weegar", "Daniil Miromanov", "Brayden Pachal"]
...
HurricanesDef = ["Brent Burns", "Jalen Chatfield", "Shayne Gostisbehere", "Dmitri Orlov", "Jaccob Slavin"]
...
AvalancheDef = ["Cale Makar", "Sam Girard", "Ryan Lindgren", "Josh Manson", "Bowen Byram", "Kurtis MacDermid", "Jacob MacDonald"]
...
Blue_JacketsDef = ["Jake Christiansen", "Jack Johnson", "Zach Werenski", "Ivan Provorov", "Jordan Harris", "Erik Gudbranson", "David Jiricek", "Damon Severson", "Dante Fabbro"]
...
StarsDef = ["Miro Heiskanen", "Esa Lindell", "Thomas Harley", "Cody Ceci", "Matt Dumba", "Lian Bichsel"]
...
Red_WingsDef = ["Ben Chiarot", "Simon Edvinsson", "Moritz Seider", "Jared McIsaac", "Gustav Lindström", "Jake Walman"]
...
OilersDef = ["Evan Bouchard", "Mattias Ekholm", "Darnell Nurse", "Cody Ceci", "Brett Kulak", "Ty Emberson", "John Klingberg"]
...
KingsDef = ["Mikey Anderson", "Joel Edmundson", "Jacob Moverare", "Drew Doughty", "Vladislav Gavrikov", "Jordan Spence", "Caleb Jones"]
...
WildDef = ["Jonas Brodin", "Declan Chisholm", "Brock Faber", "Jon Merrill", "Jacob Middleton", "Jared Spurgeon" "Zach Bogosian"]
...
CanadiensDef = ["Kaiden Guhle", "Jordan Harris", "David Savard", "Arber Xhekaj", "Lane Hutson", "Alexandre Carrier" "Mike Matheson", "Justin Barron", "Johnathan Kovacevic"]
...
PredatorsDef = ["Roman Josi", "Brady Skjei", "Jérémy Lauzon", "Andreas Englund", "Adam Wilsby", "Nick Blankenburg", "Luke Schenn"]
...
DevilsDef = ["Dougie Hamilton", "Jonas Siegenthaler", "Brenden Dillon", "Brett Pesce", "Luke Hughes", "Johnathan Kovacevic", "Seamus Casey"]
...
IslandersDef = ["Adam Pelech", "Alexander Romanov", "Ryan Pulock", "Noah Dobson", "Scott Perunovich"]
...
RangersDef = ["Ryan Lindgren", "K'Andre Miller", "Zac Jones", "Adam Fox", "Calvin de Haan", "Will Borgen", "Braden Schneider"]
...
SenatorsDef = ["Thomas Chabot", "Jake Sanderson", "Tyler Kleven", "Nick Jensen", "Travis Hamonic", "Jacob Bernard-Docker"]
...
FlyersDef = ["Jamie Drysdale", "Erik Johnson", "Rasmus Ristolainen", "Travis Sanheim", "Nick Seeler", "Cam York", "Egor Zamula"]
...
PenguinsDef = ["Ryan Graves", "Matt Grzelcyk", "Pierre-Olivier Joseph", "Ryan Shea", "Kris Letang", "Erik Karlsson", "Jack St. Ivany"]
...
SharksDef = ["Mario Ferraro", "Marc-Edouard Vlasic", "Nikita Okhotiuk", "Jan Rutta", "Matt Benning", "Henry Thrun"]
...
KrakenDef = ["Vince Dunn", "Jamie Oleksiak", "Carson Soucy", "Adam Larsson", "Justin Schultz", "Cale Fleury"]
...
BluesDef = ["Nick Leddy", "Torey Krug", "Marco Scandella", "Scott Perunovich", "Tyler Tucker", "Colton Parayko", "Justin Faulk", "Cam Fowler", "Robert Bortuzzo"]
...
LightningDef = ["Victor Hedman", "Mikhail Sergachev", "Erik Cernak", "Darren Raddysh"]
...
Maple_LeafsDef = ["Morgan Rielly", "Jake McCabe", "Simon Benoît", "Oliver Ekman-Larsson", "Chris Tanev", "Jani Hakanpaa", "Timothy Liljegren"]
...
Hockey_ClubDef = ["Mikhail Sergachev", "Ian Cole", "Michael Kesselring", "Sean Durzi", "Olli Maata", "John Marino", "Shea Weber", "Nick DeSimone"]
...
CanucksDef = ["Quinn Hughes", "Filip Hronek", "Marcus Pettersson", "Victor Mancini", "Tyler Myers", "Filip Hronek"]
...
Golden_KnightsDef = ["Shea Theodore", "Alec Martinez", "Nicolas Hague", "Brayden McNabb", "Ben Hutton", "Alex Pietrangelo", "Zach Whitecloud", "Kaedan Korczak"]
...
CapitalsDef = ["Jakob Chychrun", "Rasmus Sandin", "Martin Fehervary", "Matt Roy", "John Carlson", "Trevor van Riemsdyk", "Nick Jensen", "Brenden Dillon"]
...
JetsDef = ["Dylan DeMelo", "Dylan Samberg", "Haydn Fleury", "Ville Heinola", "Josh Morrissey", "Neal Pionk", "Colin Miller", "Logan Stanley"]
